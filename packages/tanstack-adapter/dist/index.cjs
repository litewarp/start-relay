...
__export(index_exports, {
  ...
  RelayReplayNetwork: () => RelayReplayNetwork,
  createQueryCache: () => createQueryCache,
  routerWithRelay: () => routerWithRelay
});
module.exports = __toCommonJS(index_exports);

// src/query-cache.ts
var import_relay_runtime3 = require("relay-runtime");

// src/query.ts
var import_relay_runtime = __toESM(require("relay-runtime"), 1);
...
var RelayQuery = class {
  ...
  constructor(operation) {
    ...
    this.replaySubject = new import_relay_runtime.default.ReplaySubject();
  }
  getOperation() {
...
// src/stream-utils.ts
var import_relay_runtime2 = require("relay-runtime");
function observableFromStream(stream) {
  return import_relay_runtime2.Observable.create((subscriber) => {
    stream.pipeTo(
      new WritableStream({
        write: (chunk) => {
...
// src/network.ts
var import_relay_runtime4 = __toESM(require("relay-runtime"), 1);
...
// src/network.ts
var { Network, Observable: Observable2 } = import_relay_runtime4.default;
...
var import_relay_runtime8 = require("relay-runtime");

// src/preloaded-query.ts
var import_relay_runtime5 = __toESM(require("relay-runtime"), 1);
var import_react_relay = __toESM(require("react-relay"), 1);
var { getRequest, createOperationDescriptor } = import_relay_runtime5.default;
var createPreloader = (environment, queryCache) => {
  return (request, variables, options, environmentProviderOptions) => {
    ...
    const preloadedQuery = import_react_relay.default.loadQuery(
      environment,
      request,
      variables,
      options,
...
var transportSerializationAdapter = (0, import_react_router.createSerializationAdapter)({
...
var ServerTransport = class {
  ...
  useStaticValueRef = (value) => {
    ...
    return (0, import_react.useRef)(value);
  };
};
var ClientTransport = class {
  ...
  useStaticValueRef = (value) => {
    ...
    return (0, import_react.useRef)(dataValue);
  };
};

// src/hydration.ts
var import_relay_runtime6 = require("relay-runtime");
...
function createPreloadedQuerySerializer(environment, queryCache) {
  return (0, import_react_router2.createSerializationAdapter)({
...
var import_relay_runtime7 = require("relay-runtime");
var import_react_relay2 = __toESM(require("react-relay"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var { RelayEnvironmentProvider } = import_react_relay2.default;
var DataTransportContext = (0, import_react2.createContext)(null);
function WrapRelayProvider(TransportProvider) {
  const WrappedRelayProvider2 = (props) => {
    ...
    const { environment, queryCache } = (0, import_react2.useMemo)(() => getEnvironment(), []);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RelayEnvironmentProvider, { environment, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      TransportProvider,
      {
...
var WrappedRelayProvider = WrapRelayProvider((props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DataTransportContext.Provider, { value: transport, children: props.children });
});
...
function routerWithRelay(router, environment, queryCache) {
  ...
  if (router.isServer) {
    ...
    router.options.hydrate = (dehydratedState) => {
      ...
      if (dehydratedState.recordSource) {
        environment.getStore().publish(new import_relay_runtime8.RecordSource(dehydratedState.recordSource));
      }
  ...
  const PreviousInnerWrap = ogOptions.InnerWrap ?? import_jsx_runtime3.Fragment;
  router.options.InnerWrap = ({ children }) => {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RelayProvider, { environment, queryCache, context: providerContext, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PreviousInnerWrap, { children }) });
  };
  return router;
}
